...
@Icon(value = CUSTOM, custom = "WithPngIcon") // icon is located at src/main/resources/icons/WithPngIcon.svg
@PartitionMapper(name = "WithPngIcon")
@Documentation("TODO fill the documentation for this mapper")
public class WithPngIconMapper implements Serializable {
    private final WithPngIconMapperConfiguration configuration;
    private final IconTesterService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public WithPngIconMapper(@Option("configuration") final WithPngIconMapperConfiguration configuration,
    ...
    @Split
    public List<WithPngIconMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 WithPngIconMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public WithPngIconSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new WithPngIconSource(configuration, service, recordBuilderFactory);
    }
}